...
<<bigTable, cache=TRUE, eval=FALSE>>=
...
<<PCA_Labs, cache=TRUE, eval=FALSE>>=
...
<<PCApairs, cache=TRUE, eval=FALSE>>=
...
<<ProjectChr1Chr20, cache=TRUE, eval=FALSE>>=
...
<<CheckSeqContent, cache=TRUE, eval=FALSE>>=
